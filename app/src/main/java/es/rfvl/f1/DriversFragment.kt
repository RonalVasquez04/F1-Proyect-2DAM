...
class DriversFragment : Fragment() , driversAdapter.OnDriversClickListener{
    ...
    private fun setUpRecyclerView() {
        var corredores= mutableListOf<Drivers>(
            ...
            Drivers("Sergio", "Perez", "Red Bull Racing", R.drawable.max_verstappen,"8","34","21","256","0", "Mexico","26/01/1990"),
            ...
            Drivers("Lando", "Norris", "McLaren", R.drawable.max_verstappen,"7","13","21","102","0","United Kingdom", "13/11/1999"),
            ...
            Drivers("George", "Russell", "Mercedes", R.drawable.max_verstappen,"1","10","21","102","0","United KIngdom","15/02/1998"),
            Drivers("Oscar", "Piastri", "McLaren", R.drawable.max_verstappen,"2","2","21","20","0","Australia","06/04/2001"),
            Drivers("Lance", "Stroll", "Aston Martin", R.drawable.max_verstappen,"0","3","21","141","0","Canada","29/10/1998"),
            Drivers("Pierre", "Gasly", "Alpine", R.drawable.max_verstappen,"1","4","21","128","0","France","07/02/1996"),
            Drivers("Esteban", "Ocon", "Alpine", R.drawable.max_verstappen,"1","3","21","121","0","France","17/09/1996"),
            Drivers("Alexander", "Albon", "Williams", R.drawable.max_verstappen,"0","2","21","79","0","Thailand","23/03/1996"),
            Drivers("Yuki", "Tsunoda", "AlphaTauri", R.drawable.max_verstappen,"0","0","21","64","0","Japan","11/05/2000"),
            Drivers("Valtteri", "Bottas", "Alfa Romeo", R.drawable.max_verstappen,"0","67","21","120","0","Finland","28/08/1989"),
            Drivers("Nico", "Hulkenberg", "Haas F1 Team", R.drawable.max_verstappen,"0","0","21","204","0","Germany","19/08/1987"),
            Drivers("Daniel", "Ricciardo", "AlphaTauri", R.drawable.max_verstappen,"0","32","21","237","0","Australia","01/07/1989"),
            Drivers("Zhou", "Guanyu", "Alfa Romeo", R.drawable.max_verstappen,"0","0","21","42","0","China","30/05/1999"),
            Drivers("Kevin", "Magnussen", "Haas F1 Team", R.drawable.max_verstappen,"0","1","21","162","0","Denmark","05/10/1992"),
            Drivers("Liam", "Lawson", "AlphaTauri", R.drawable.max_verstappen,"0","0","21","5","0","New Zealand","11/02/2002"),
            Drivers("Logan", "Sargeant", "Williams", R.drawable.max_verstappen,"0","0","21","20","0","USA","31/12/2000"),
            Drivers("Nyck", "De Vries", "AlphaTauri", R.drawable.max_verstappen,"0","0","21","11","0","Netherlands","06/02/1995")
